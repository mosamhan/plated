...
/**
 * Discover's own settings — same shape as Ranks settings, but Discover has
 * nothing equivalent to Ranks' Restaurants/Plates chooser, so the only
 * section is Location: Near (the app's location, or a picked city, radius-
 * limited) vs Global (everywhere, unfiltered).
 */
export function DiscoverSettingsSheet({
  ...
  /** The location "Near" is currently resolving to — device/app location, or a picked city. */
  nearLabel: string;
    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <Pressable style={styles.backdrop} onPress={onClose}>
        <Pressable
          ...
          <Text style={[styles.title, { color: colors.text, fontFamily: displayFont }]}>Discover settings</Text>
          ...
          {scope === 'near' && (
            <Pressable
              ...
              <Text style={[styles.linkLabel, { color: colors.text }]}>Browsing near</Text>
